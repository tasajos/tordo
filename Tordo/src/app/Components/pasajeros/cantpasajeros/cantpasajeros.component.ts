...
@Component({
  selector: 'app-cantpasajeros',
  templateUrl: './cantpasajeros.component.html',
  styleUrls: ['./cantpasajeros.component.css']
})
export class CantpasajerosComponent implements OnInit {
...
cantidadPasajeros: number = 0;
  ...
  onSearch() {
    ...
    this.cantidadPasajeros = 0; // Inicializa la variable cantidadPasajeros
      ...
      const filteredData = this.dataSource.data.filter(item => {
        ...
        if (this.startDate !== null && this.endDate !== null) {
          ...
          if (isIncluded) {
            ...
            this.cantidadPasajeros++; // Incrementa la cantidad de pasajeros
          }
