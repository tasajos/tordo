...
@Component({
  selector: 'app-adregistrarflotas',
  templateUrl: './adregistrarflotas.component.html',
  styleUrls: ['./adregistrarflotas.component.css']
})
export class AdregistrarflotasComponent implements OnInit {
