...
@Component({
  selector: 'app-admanifestogral',
  templateUrl: './admanifestogral.component.html',
  styleUrls: ['./admanifestogral.component.css']
})
export class AdmanifestogralComponent  implements OnInit {
