...
@Component({
  selector: 'app-admanifestoflota',
  templateUrl: './admanifestoflota.component.html',
  styleUrls: ['./admanifestoflota.component.css']
})
export class AdmanifestoflotaComponent implements OnInit {
