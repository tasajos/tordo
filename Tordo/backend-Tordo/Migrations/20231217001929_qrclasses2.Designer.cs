...
namespace backend_Tordo.Migrations
{
    ...
    [Migration("20231217001929_qrclasses2")]
    partial class qrclasses2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend_Tordo.Models.QRClases.ObjetoRespuesta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Tordo_QRC_QRresponse");
                });

            modelBuilder.Entity("backend_Tordo.Models.QRClases.PageInfo", b =>
                {
            ...
            modelBuilder.Entity("backend_Tordo.Models.QRClases.RespuestaModelo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Tordo_QRC_Responses");
                });

            modelBuilder.Entity("backend_Tordo.Models.QRClases.RespuestaModelo", b =>
                {
                    b.HasOne("backend_Tordo.Models.QRClases.PageInfo", "pageInfo")
                        .WithMany()
                        .HasForeignKey("PageInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("backend_Tordo.Models.QRClases.ObjetoRespuesta", "objeto")
                        .WithMany()
